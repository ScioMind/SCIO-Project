...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    //	strUsage += "  -port=<port>           " + strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 51472, 51474) + "\n";
    	strUsage += "  -port=<port>           " + strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 41816, 41818 ) + "\n";// 1 before 41817, 1 before 41819
    //	END EDIT
	...
	strUsage += "  -rpcport=<port>        " + strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 41817, 41819) + "\n";// ScioCoin values
    // END EDIT
