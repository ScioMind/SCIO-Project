...
public:
	...
	//	const char* pszTimestamp = "U.S. News & World Report Jan 28 2016 With His Absence, Trump Dominates Another Debate";
		const char* pszTimestamp = "Apr 18 2017 Scionics Institute initiates development of ScioCoin. Knowledge is Power!";
	//	END EDIT
	...
	//	SCIOEDIT
		...
		genesis.nTime = 1492531200; // Somewhere around mid-day, on Apr 18 2017, somewhere in the world.
	//	END EDIT
	...
	//	SCIOEDIT
	//	If needed, replace the below with new mainnet seed nodes.
	...
	//	SCIOEDIT
        //	base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 30); // 'X'
